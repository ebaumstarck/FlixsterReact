# Project 1 - *FlixsterReact*

**FlixsterReact** is a movies app using the [The Movie Database API](http://docs.themoviedb.apiary.io/#).
...
<img src='i.imgur.com/a/5W2ue.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
